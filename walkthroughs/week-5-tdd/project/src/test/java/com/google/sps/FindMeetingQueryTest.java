...
public final class FindMeetingQueryTest {
  ...
  private static final String OPTIONAL_PERSON_C = "Person C";
  private static final String OPTIONAL_PERSON_B = "Person B";
  ...
  @Test
  public void everyAttendeeIsConsideredWithOptionalNot() {
    // C is not not invited because of all day event.
    // Events C: |--------------C--------------|
    // Events  :       |--A--|     |--B--|
    // Day     : |-----------------------------|
    // Options : |--1--|     |--2--|     |--3--|
    ...
    Collection<Event> events = Arrays.asList(
        ...
        new Event("Event 2", TimeRange.fromStartDuration(TIME_0900AM, DURATION_30_MINUTES),
            Arrays.asList(PERSON_B)),
        new Event("Event 3", TimeRange.fromStartDuration(TIME_0000AM, DURATION_WHOLE_DAY),
  ...
  public void noMandatoryAttendees() {
    // Have two optional attendees times returned, to
    // have the meeting.
    // Events A:  |-a-|    |-a-|    
    // Events B: |-b-|     |-b-|
    // Day     : |---------------------|
  ...
  @Test
  public void noMandatoryAttendeesAndOptional() {
    // Have two optional attendees times returned, to
    // have the meeting.
    // Events A:  |-a-|    |-a-|    
    // Events B: |-b-|     |-b-|
